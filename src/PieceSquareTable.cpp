...
const Score PieceSquareTable::PSQ_Bonus[NONE][R_NO][F_NO/2] =
{
    { // Pawn
...
Score PieceSquareTable::PSQ[CLR_NO][NONE][SQ_NO];

// Initialize PSQ table
void PieceSquareTable::initialize ()
{
...
Score PieceSquareTable::compute_psq_score (const Position &pos) const
{
...
PieceSquareTable PSQTable; // Global Piece-Square Table
