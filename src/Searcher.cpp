...
#   endif
    ...
    #undef V
        ...
        void check_limits ()
        {
            ...
            if (   (Limits.time_management_used () && elapsed_time > main_thread->time_mgr.maximum_time - 2 * TimerResolution)
            ...
            while ((move = mp.next_move ()) != MOVE_NONE)
            {
                   ...
                   )
                {
                       ...
                       )
                    {
                        ...
                        full_depth_search = alfa < value && reduction_depth/2 > DEPTH_ZERO;
                    }
                }
                else
                {
