...
//    iss >> std::noskipws;
//    File kf[+Color::NO] = { File::NO, File::NO };
//    u08 token;
//    size_t idx;
//    i08 f = +File::fA;
//    i08 r = +Rank::r8;
...
//        }
//    }
//    assert(File::NO != kf[+Color::WHITE]
//        && File::NO != kf[+Color::BLACK]);
//
//    iss >> token;
//    if (Color::WHITE == Color(ColorChar.find (token)))
//    {
//        fen_key ^= color_key;
//    }
//
...
//           && !isspace (token))
//    {
//        auto c = isupper (token) ? Color::WHITE : Color::BLACK;
